...
for hour in hours:
    ...
    for minute in minutes:
        ...
        # 將DataFrame的欄位重新命名
        data.columns = ['TimeInterval', 'GantryFrom', 'GantryTo', 'VehicleType', 'SpaceMeanSpeed','交通量']
        
        # 將這個檔案的資料加到all_data DataFrame中
        all_data = pd.concat([all_data, data])

# 將所有的資料儲存到桌面
all_data.to_csv("C:/Users/WINNIE/Desktop/M05.csv", index=False, sep=',', encoding='utf-8-sig')